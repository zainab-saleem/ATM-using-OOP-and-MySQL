...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Choose Your Category";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(38, 157);
			...
			this->button2->Location = System::Drawing::Point(185, 157);
